...
def DrawGLScene():
    ...
    glTexCoord2f(0.0, 0.0); glVertex3f(-1.0, -1.0,  1.0)   #um 
    ...
    # Back Face
    glTexCoord2f(2/3, 1/2); glVertex3f(-1.0, -1.0, -1.0)    #seis
    glTexCoord2f(2/3, 1.0); glVertex3f(-1.0,  1.0, -1.0)    
    glTexCoord2f(1.0, 1.0); glVertex3f( 1.0,  1.0, -1.0)    
    glTexCoord2f(1.0, 1/2); glVertex3f( 1.0, -1.0, -1.0)   
    
    # Top Face
    glTexCoord2f(1/3, 0.0); glVertex3f(-1.0,  1.0, -1.0)   #dois
    glTexCoord2f(1/3, 1/2); glVertex3f(-1.0,  1.0,  1.0)    
    glTexCoord2f(2/3, 1/2); glVertex3f( 1.0,  1.0,  1.0)    
    glTexCoord2f(2/3, 0.0); glVertex3f( 1.0,  1.0, -1.0)   

    # Bottom Face       
    glTexCoord2f(1/3, 1/2); glVertex3f(-1.0, -1.0, -1.0)   #cinco
    glTexCoord2f(1/3, 1.0); glVertex3f( 1.0, -1.0, -1.0)   
    glTexCoord2f(2/3, 1.0); glVertex3f( 1.0, -1.0,  1.0)   
    glTexCoord2f(2/3, 1/2); glVertex3f(-1.0, -1.0,  1.0)    
    
    # Right face
    glTexCoord2f(0.0, 1/2); glVertex3f( 1.0, -1.0, -1.0)  #quatro
    glTexCoord2f(0.0, 1.0); glVertex3f( 1.0,  1.0, -1.0)   
    glTexCoord2f(1/3, 1.0); glVertex3f( 1.0,  1.0,  1.0)    
    glTexCoord2f(1/3, 1/2); glVertex3f( 1.0, -1.0,  1.0)  
    
    # Left Face
    glTexCoord2f(2/3, 0.0); glVertex3f(-1.0, -1.0, -1.0)  #tres
    glTexCoord2f(2/3, 1/2); glVertex3f(-1.0, -1.0,  1.0)    
    glTexCoord2f(1.0, 1/2); glVertex3f(-1.0,  1.0,  1.0)   
